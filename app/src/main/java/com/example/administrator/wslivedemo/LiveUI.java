       ...
       switch (view.getId()){
           case R.id.btn_startStreaming://开始推流
               if(!liveCameraView.isStreaming()){
                   btnStartStreaming.setTextColor(Color.parseColor("#999999"));
                   btnStopStreaming.setTextColor(Color.parseColor("#333333"));
                   liveCameraView.startStreaming(rtmpUrl);
               }
               break;
           case R.id.btn_stopStreaming://停止推流
               if(liveCameraView.isStreaming()){
                   btnStartStreaming.setTextColor(Color.parseColor("#333333"));
                   btnStopStreaming.setTextColor(Color.parseColor("#999999"));
